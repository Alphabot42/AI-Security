...
class ChatManager:
    ...
    def _init_session_state(self):
        ...
        if "agent_arn" not in st.session_state:
            agent_arn = get_ssm_parameter("/app/cti/agentcore/runtime_arn")
    ...
    def display_chat_history(self):
        ...
        for message in messages_to_show:
            ...
            emoji = "🧑‍💻" if message["role"] == "user" else "🛡️"
        ...
        with st.chat_message("assistant"):
            ...
            for chunk in self.invoke_endpoint(
                ...
                if chunk.strip():
                    ...
                    create_safe_markdown_text(
                        f'<div class="assistant-bubble streaming typing-cursor">🛡️ {clickable_streaming_text}</div>',
                        message_placeholder,
                    )
            ...
            create_safe_markdown_text(
                f'<div class="assistant-bubble">🛡️ {clickable_streaming_text}<br><span style="font-size:0.9em;color:#888;">⏱️ Response time: {elapsed:.2f} seconds</span></div>',
                message_placeholder,
            )
